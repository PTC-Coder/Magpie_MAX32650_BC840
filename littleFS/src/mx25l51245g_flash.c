...
LOG_MODULE_REGISTER(mx25l51245g, LOG_LEVEL_WRN);
...
static struct spi_config spi_cfg = {
    .frequency = 8000000,  // 1MHz - slower for debugging
...
static struct lfs_config lfs_cfg = {
    ...
    .block_count = 16384UL,                     // 64MB total (4096 * 4KB)
...
static lfs_t lfs;
static uint8_t lfs_read_buffer[MX25L51245G_PAGE_SIZE];  //MX25L51245G_PAGE_SIZE
